...
public class InstructionQueueTest {
    ...
    private List<InstructionMessage> expectOrderedMessages;
    ...
    public void setUp() throws ParseException, ValidationException {
        ...
        expectOrderedMessages.add(expectMessageAType);
        underTest.enqueue(expectMessageCType);
        expectOrderedMessages.add(expectMessageAType1);
        underTest.enqueue(expectMessageAType);
        expectOrderedMessages.add(expectMessageBType1);
        underTest.enqueue(expectMessageDType);
        expectOrderedMessages.add(expectMessageBType);
        underTest.enqueue(expectMessageAType1);
        expectOrderedMessages.add(expectMessageCType);
        underTest.enqueue(expectMessageBType);
        expectOrderedMessages.add(expectMessageDType);
        underTest.enqueue(expectMessageDType);
        expectOrderedMessages.add(expectMessageDType);
